...
function xe(r4, e, t, i = "brackets") {
  ...
  return r4 === "get" && Object.keys(t).length && (c.search = M.stringify(mergeWith(M.parse(c.search, { ignoreQueryPrefix: true }), t, (l, h, F, P) => {
    h === void 0 && delete P[F];
...
function Fe(r4, e, t) {
  ...
  function p() {
    let l = e(""), h = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, F = Object.values(i).reduce((P, E) => P.concat(E), []).reduce((P, E) => {
      if (E.indexOf("<") === -1) return P;
      if (E.indexOf("<title ") === 0) {
        let H = E.match(/(<title [^>]+>)(.*?)(<\/title>)/);
        return P.title = H ? `${H[1]}${e(H[2])}${H[3]}` : E, P;
      }
      let ce2 = E.match(/ inertia="[^"]+"/);
      return ce2 ? P[ce2[0]] = E : P[Object.keys(P).length] = E, P;
    }, h);
...
function _2({ children: s, initialPage: t, initialComponent: a2, resolveComponent: p, titleCallback: i, onHeadUpdate: g2 }) {
  let [u, f2] = (0, import_react2.useState)({ component: a2 || null, page: t, key: null }), c = (0, import_react2.useMemo)(() => Fe(typeof window > "u", i || ((l) => l), g2 || (() => {
  })), []);
  if ((0, import_react2.useEffect)(() => {
    jr.init({ initialPage: t, resolveComponent: p, swapComponent: async ({ component: l, page: e, preserveState: d }) => {
      f2((r4) => ({ component: l, page: e, key: d ? r4.key : Date.now() }));
    } }), jr.on("navigate", () => c.forceUpdate());
  ...
  let m2 = s || (({ Component: l, props: e, key: d }) => {
    ...
    return typeof l.layout == "function" ? l.layout(r4) : Array.isArray(l.layout) ? l.layout.concat(r4).reverse().reduce((h, F) => (0, import_react2.createElement)(F, { children: h, ...e })) : r4;
  });
...
async function ce({ id: s = "app", resolve: t, setup: a2, title: p, progress: i = {}, page: g2, render: u }) {
  let f2 = typeof window > "u", c = f2 ? null : document.getElementById(s), m2 = g2 || JSON.parse(c.dataset.page), l = (r4) => Promise.resolve(t(r4)).then((h) => h.default || h), e = [], d = await Promise.all([l(m2.component), jr.decryptHistory().catch(() => {
...
var Be2 = fe2;
var je = function({ children: s, title: t }) {
...
var he2 = (0, import_react8.forwardRef)(({ children: s, as: t = "a", data: a2 = {}, href: p, method: i = "get", preserveScroll: g2 = false, preserveState: u = null, replace: f2 = false, only: c = [], except: m2 = [], headers: l = {}, queryStringArrayFormat: e = "brackets", async: d = false, onClick: r4 = x2, onCancelToken: h = x2, onBefore: F = x2, onStart: I2 = x2, onProgress: E = x2, onFinish: Y2 = x2, onCancel: N2 = x2, onSuccess: z2 = x2, onError: M2 = x2, prefetch: v2 = false, cacheFor: b2 = 0, ...G2 }, X2) => {
  ...
  let [k2, ee2] = xe(i, typeof p == "object" ? p.url : p || "", a2, e), A2 = k2;
  a2 = ee2;
  let $2 = { data: a2, method: i, preserveScroll: g2, preserveState: u ?? i !== "get", replace: f2, only: c, except: m2, headers: l, async: d }, W2 = { ...$2, onCancelToken: h, onBefore: F, onStart(o) {
    j2((w2) => w2 + 1), I2(o);
  }, onProgress: E, onFinish(o) {
    j2((w2) => w2 - 1), Y2(o);
  }, onCancel: N2, onSuccess: z2, onError: M2 }, H = () => {
    jr.prefetch(A2, $2, { cacheFor: te2 });
  }, R2 = (0, import_react8.useMemo)(() => v2 === true ? ["hover"] : v2 === false ? [] : Array.isArray(v2) ? v2 : [v2], Array.isArray(v2) ? v2 : [v2]), te2 = (0, import_react8.useMemo)(() => b2 !== 0 ? b2 : R2.length === 1 && R2[0] === "click" ? 0 : 3e4, [b2, R2]);
  ...
  let n2 = { onClick: (o) => {
    r4(o), Ne(o) && (o.preventDefault(), jr.visit(A2, W2));
  } }, y2 = { onMouseEnter: () => {
    ...
    clearTimeout(L2.current);
  }, onClick: n2.onClick }, P = { onMouseDown: (o) => {
    Ne(o) && (o.preventDefault(), H());
  }, onMouseUp: (o) => {
    o.preventDefault(), jr.visit(A2, W2);
  }, onClick: (o) => {
    r4(o), Ne(o) && o.preventDefault();
  } };
  return i !== "get" && (t = "button"), (0, import_react8.createElement)(t, { ...G2, ...{ a: { href: A2 }, button: { type: "button" } }[t] || {}, ref: X2, ...R2.includes("hover") ? y2 : R2.includes("click") ? P : n2, "data-loading": Z2 > 0 ? "" : void 0 }, s);
});
...
function ve2(s, t) {
  let a2 = (0, import_react9.useRef)(null), p = typeof s == "string" ? s : null, [i, g2] = (0, import_react9.useState)((typeof s == "string" ? t : s) || {}), u = (0, import_react9.useRef)(null), f2 = (0, import_react9.useRef)(null), [c, m2] = p ? V2(i, `${p}:data`) : (0, import_react9.useState)(i), [l, e] = p ? V2({}, `${p}:errors`) : (0, import_react9.useState)({}), [d, r4] = (0, import_react9.useState)(false), [h, F] = (0, import_react9.useState)(false), [I2, E] = (0, import_react9.useState)(null), [Y2, N2] = (0, import_react9.useState)(false), [z2, M2] = (0, import_react9.useState)(false), v2 = (0, import_react9.useRef)((n2) => n2);
  (0, import_react9.useEffect)(() => (a2.current = true, () => {
    a2.current = false;
  }), []);
  let b2 = (0, import_react9.useCallback)((...n2) => {
    let y2 = typeof n2[0] == "object", P = y2 ? n2[0].method : n2[0], C2 = y2 ? n2[0].url : n2[1], o = (y2 ? n2[1] : n2[2]) ?? {}, w2 = { ...o, onCancelToken: (S2) => {
      if (u.current = S2, o.onCancelToken) return o.onCancelToken(S2);
    }, onBefore: (S2) => {
      if (N2(false), M2(false), clearTimeout(f2.current), o.onBefore) return o.onBefore(S2);
    }, onStart: (S2) => {
      if (F(true), o.onStart) return o.onStart(S2);
    }, onProgress: (S2) => {
      if (E(S2), o.onProgress) return o.onProgress(S2);
    }, onSuccess: (S2) => {
      if (a2.current && (F(false), E(null), e({}), r4(false), N2(true), M2(true), g2(cloneDeep(c)), f2.current = setTimeout(() => {
        a2.current && M2(false);
      }, 2e3)), o.onSuccess) return o.onSuccess(S2);
    }, onError: (S2) => {
      if (a2.current && (F(false), E(null), e(S2), r4(true)), o.onError) return o.onError(S2);
    }, onCancel: () => {
      if (a2.current && (F(false), E(null)), o.onCancel) return o.onCancel();
    }, onFinish: (S2) => {
      if (a2.current && (F(false), E(null)), u.current = null, o.onFinish) return o.onFinish(S2);
    } };
    P === "delete" ? jr.delete(C2, { ...w2, data: v2.current(c) }) : jr[P](C2, v2.current(c), w2);
  }, [c, e, v2]), G2 = (0, import_react9.useCallback)((n2, y2) => {
    m2(typeof n2 == "string" ? (P) => set(cloneDeep(P), n2, y2) : typeof n2 == "function" ? (P) => n2(P) : n2);
  }, [m2]), X2 = (0, import_react9.useCallback)((n2, y2) => {
    g2(typeof n2 > "u" ? () => c : (P) => typeof n2 == "string" ? set(cloneDeep(P), n2, y2) : Object.assign(cloneDeep(P), n2));
  }, [c, g2]), Z2 = (0, import_react9.useCallback)((...n2) => {
    n2.length === 0 ? m2(i) : m2((y2) => n2.filter((P) => has(i, P)).reduce((P, C2) => set(P, C2, get(i, C2)), { ...y2 }));
  }, [m2, i]), j2 = (0, import_react9.useCallback)((n2, y2) => {
    e((P) => {
      let C2 = { ...P, ...typeof n2 == "string" ? { [n2]: y2 } : n2 };
      return r4(Object.keys(C2).length > 0), C2;
    });
  }, [e, r4]), L2 = (0, import_react9.useCallback)((...n2) => {
    e((y2) => {
      let P = Object.keys(y2).reduce((C2, o) => ({ ...C2, ...n2.length > 0 && !n2.includes(o) ? { [o]: y2[o] } : {} }), {});
      return r4(Object.keys(P).length > 0), P;
    });
  }, [e, r4]), k2 = (n2) => (y2, P) => {
    b2(n2, y2, P);
  ...
  return { data: c, setData: G2, isDirty: !isEqual(c, i), errors: l, hasErrors: d, processing: h, progress: I2, wasSuccessful: Y2, recentlySuccessful: z2, transform: te2, setDefaults: X2, reset: Z2, setError: j2, clearErrors: L2, submit: b2, get: ee2, post: A2, put: $2, patch: W2, delete: H, cancel: R2 };
}
function Te2(s, t = {}, a2 = { keepAlive: false, autoStart: true }) {
  let p = (0, import_react11.useRef)(jr.poll(s, t, { ...a2, autoStart: false }));
...
function be2(s = {}) {
  let t = typeof window > "u" ? null : jr.getCached(window.location.pathname, s), a2 = typeof window > "u" ? null : jr.getPrefetching(window.location.pathname, s), [p, i] = (0, import_react12.useState)((t == null ? void 0 : t.staleTimestamp) || null), [g2, u] = (0, import_react12.useState)(a2 !== null), [f2, c] = (0, import_react12.useState)(t !== null);
  return (0, import_react12.useEffect)(() => {
    let m2 = jr.on("prefetching", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && u(true);
    }), l = jr.on("prefetched", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && (u(false), c(true), i(e.detail.fetchedAt));
    });
    return () => {
      l(), m2();
    };
  }, []), { lastUpdatedAt: p, isPrefetching: g2, isPrefetched: f2, flush: () => jr.flush(window.location.pathname, s) };
}
var Ce2 = ({ children: s, data: t, params: a2, buffer: p, as: i, always: g2, fallback: u }) => {
  ...
  return (0, import_react13.useEffect)(() => {
    ...
    let r4 = new IntersectionObserver((h) => {
      ...
      let F = d();
      jr.reload({ ...F, onStart: (I2) => {
        var _a;
        l.current = true, (_a = F.onStart) == null ? void 0 : _a.call(F, I2);
      }, onFinish: (I2) => {
        var _a;
        c(true), l.current = false, (_a = F.onFinish) == null ? void 0 : _a.call(F, I2), g2 || r4.disconnect();
      } });
    }, { rootMargin: `${p || 0}px` });
